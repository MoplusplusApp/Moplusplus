#ifndef UI_MOPLUSPLUSMAIN_CPP
#define UI_MOPLUSPLUSMAIN_CPP

#include "ui_moplusplusmain.h"

// TL; DR - This file defines the layout of the application
...
void BorderLayout::setGeometry(const QRect &rect)
{
    ...
    centerHeight = rect.height() - northHeight;
